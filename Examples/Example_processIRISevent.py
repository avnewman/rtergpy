...
# Chignik_20210729
eloc = [55.364, -157.888, 32.2]  # lat, lon, depth in km
etime = UTCDateTime(2021, 7, 29, 6, 15, 49)  # Chignik_20210729 UTC time
Event.ecount='00'
Event.newData=True   # use already downloaded data
#Event.newData=True
